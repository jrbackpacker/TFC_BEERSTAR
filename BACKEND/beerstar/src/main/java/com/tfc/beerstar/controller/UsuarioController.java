...
public class UsuarioController {
    ...
    @GetMapping(path = "/obtenerUsuario/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(path = "/actualizarUsuario/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    // Eliminar un usuario
    @DeleteMapping(path = "/eliminarUsuario/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
